...
frl_data <- read_excel(paste0("./Input/education/southdakota_",year,"_frl.xls"),sheet='SORT BY COUNTY - PUBLIC ONLY') %>%
  ...
  rename(data='Free & Red Price Elig %') %>%
...
upload_sql <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM ", statefile," WHERE timeframe='",year,"' AND varname='freereducedlunch' AND locationtype='County';")
