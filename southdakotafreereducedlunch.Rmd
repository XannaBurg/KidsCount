...
```{r}
frl_data <- read_excel(paste0("./Input/education/southdakota_",year,"_frl.xlsx"),sheet='Sort by County PUBLIC') %>%
...
frl_data_tribal <- read_excel(paste0("./Input/education/southdakota_",year,"_frl.xlsx"),sheet='Sort by School PUBLIC') %>%
  rename(school='School/Agency Name',
