...
## ############################ ##
```{r}
act_composite <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ACT_Data_",year,".xlsx"),sheet=paste0(year," Mean ACT Composite")) %>%
...
act_allstudents <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ACT_Data_",year,".xlsx"),sheet=paste0(year," ACT by Subject")) %>%
