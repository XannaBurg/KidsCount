...
```{r}
#import the data
ncands <- read_excel(path=paste0("./Input/safety/northdakota_",year,"_ncandschildabuse.xlsx"), guess_max = 1048576) %>%
...
assessment$data[assessment$location=='Pembina'] <- NA
...
#******
#CHANGE TO THE CORRECT COUNTY NAME HERE
allegedvictims_toupload$data[allegedvictims_toupload$location=='Sargent'] <- NA
...
victims$data[victims$location=='Pembina'] <- NA
