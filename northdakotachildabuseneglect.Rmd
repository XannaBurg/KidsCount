...
```{r}
#import the data
ncands <- read_excel(path=paste0("./Input/safety/northdakota_",year,"_ncandschildabuse.xlsx"), guess_max = 1048576,sheet='Page1',skip=7) %>%
...
#assessment$data[assessment$location=='Foster'] <- NA
...
#******
#CHANGE TO THE CORRECT COUNTY NAME HERE
#allegedvictims_toupload$data[allegedvictims_toupload$location=='Foster'] <- NA
