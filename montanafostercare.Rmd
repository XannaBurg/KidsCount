...
excel0to17_county <- dbGetQuery(con,excel0to17_sql) %>%
  ...
  pivot_wider(names_from='dataformat', values_from=c('2017','2018','2019','2020')) %>%
  select(c(`location`,`2020_Number`,`2020_Rate`,`2019_Number`,`2019_Rate`,`2018_Number`,`2018_Rate`,`2017_Number`,`2017_Rate`)) %>%
