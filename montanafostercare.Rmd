...
fostercaredata <- read_excel(path=paste0("./Input/safety/montana_",year_short,"_fostercaredata.xlsx"),sheet='2023 Unduplicated Kids in Care') 
```
...
excel0to17_county <- dbGetQuery(con,excel0to17_sql) %>%
  ...
  pivot_wider(names_from='dataformat', values_from=c('2017','2018','2019','2020','2021','2022','2023')) %>%
  select(c(`location`,`2023_Number`,`2023_Rate`,`2022_Number`,`2022_Rate`,`2021_Number`,`2021_Rate`,
