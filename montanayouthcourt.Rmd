...
youthdata <- read_excel(path=paste0("./Input/safety/montana_",fullyear,"_juvenilereferralsandyouth.xlsx"),sheet=fullyear,skip=2)
...
```{r}
#import the data
offensedata <- read_excel(path=paste0("./Input/safety/montana_",fullyear,"_juvenileoffenses.xlsx"),sheet=fullyear)
