...
bestbeginnings_county <- read_excel(path=paste0("./Input/education/montana_childcaredata_",year,"v2.xlsx"),sheet=paste0("BBS Indicator 1, 2, 3 SFY ",year),skip=32) 
...
```{r}
#read in the data that was shared by DPHHS
childcare_data <- read_excel(path=paste0("./Input/education/montana_childcaredata_",year,".xlsx"),sheet=paste0("Indicator 1, 2, 3 SFY ",year),skip=25) 
