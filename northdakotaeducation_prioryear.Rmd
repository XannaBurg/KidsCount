...
#note, we are no longer publishing region data, so starting with 2023-24 data, I removed it from the code. 
...
#import data
homeless_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/3-Homelessness.xlsx")) %>%
  ...
  mutate(CountyCode=as.numeric(paste(County))) %>%
  subset(!is.na(CountyCode)) %>%
  subset(!is.na(denominator))
...
homeless_all <- homeless_county %>%
  ...
  #supress if denominator is less than 25
  mutate(suppress_denominator=if_else(totalenroll<25 | is.na(totalenroll),1,0)) %>%
  ...
  #suppress percentages of 0-10 if between 25 to 40 in denominator
  mutate(suppress_0to10_21=if_else((totalenroll>=25 & totalenroll<=40) & 
                                     homeless_percent<=0.10,1,0)) %>%
  #suppress percentages of 90-100 if between 25 to 40 in denominator
  mutate(suppress_90to100_21=if_else((totalenroll>=25 & totalenroll<=40) & 
  ...
  mutate(homeless_percent_suppressed=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      ...
      suppress_0to10_21==0 & suppress_90to100_21==0 ~ homeless_percent)) %>%
  ...
  mutate(homeless_number_suppressed=case_when(
    ...
    suppress_95to100_41==1 | suppress_0to10_21==1 | suppress_90to100_21==1 ~ 'NA',
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0  ~ homeless_number)) %>%
...
```{r}
#import data
financials <- read.csv(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/FinancialData_",year,".csv"))
...
adm_all <- adm_county %>%
  ...
  #supress if denominator is less than 25
  mutate(suppress_denominator=if_else(data<25 | is.na(data),1,0)) %>%
...
```{r}
#import data
grad_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/4-Grad_Rates.xlsx")) %>%
...
grad_all <- grad_county %>%
  ...
  mutate(grad_percent_suppressed=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0 ~ grad_percent)) %>%
  ...
  mutate(grad_number_suppressed=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0  ~ grad_number)) %>%
...
datacenter_sql <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM northdakota WHERE timeframe='",fullyear,"' AND (locationtype='State' OR locationtype='County' OR locationtype='Tribal Area') AND varname='graduationrate4cohort';")
...
STEP 1: Import and Clean Data
```{r}
grad_data2 <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/4-Grad_Rates.xlsx")) %>%
  rename(ontime_Count='On-Time Grads',
         Total_Students='Cohort') %>%
...
gradrace_all <- gradrace_county2 %>%
  ...
  #supress if denominator is less than 25
  mutate(suppress_denominator=if_else(summed_denominator<25 | is.na(summed_denominator),1,0)) %>%
  ...
  #suppress percentages of 0-10 if between 25 to 40 in denominator
  mutate(suppress_0to10_21=if_else((summed_denominator>=25 & summed_denominator<=40) & 
                                     gradrate_percent<=0.10,1,0)) %>%
  #suppress percentages of 90-100 if between 25 to 40 in denominator
  mutate(suppress_90to100_21=if_else((summed_denominator>=25 & summed_denominator<=40) & 
  ...
  mutate(data=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0  ~ gradrate_percent)) %>%
...
#import data
dropout_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/5-DropOuts7-12.xlsx")) %>%
...
dropout_all <- dropout_county %>%
  ...
  mutate(dropout_percent_suppressed=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0 ~ dropout_percent)) %>%
  ...
  mutate(dropout_number_suppressed=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0 ~ dropout_number)) %>%
...
datacenter_sql <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM northdakota WHERE timeframe='",fullyear,"' AND (locationtype='State' OR locationtype='County' OR locationtype='Tribal Area') AND varname='grades7to12eventdropoutrate';")
...
```{r}
#import data
assessment_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/6-ThirdGradeAssess.xlsx")) %>%
...
assessment_all <- assessment_county %>%
  ...
  mutate(data=case_when(
    ...
    suppress_denominator==0 & suppress_0to1_300==0 & suppress_99to100_300==0 & 
      suppress_0to2_101==0 & suppress_98to100_101==0 & 
      suppress_0to5_41==0 & suppress_95to100_41==0 & 
      suppress_0to10_21==0 & suppress_90to100_21==0 ~ proficient_percent)) %>%
...
#import data
assessment_data1 <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Assessment_Grade3_",yearfile1,".xlsx")) %>%
...
assessment_data2 <- read_excel(path=paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2024 Request/6-ThirdGradeAssess.xlsx")) %>%
  
  #subset for all students
  subset(SubGroup_Desc=='All') %>%
  subset(Subject=='Reading') 

assessment_data3 <- read_excel(path=paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/ND Kids Count 2025 Request/6-ThirdGradeAssess.xlsx")) %>%
