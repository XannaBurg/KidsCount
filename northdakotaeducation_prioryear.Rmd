...
```{r}
#import data
grad_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Grad_Rates_",year,".xlsx")) %>%
...
STEP 1: Import and Clean Data
```{r}
grad_data2 <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Grad_Rates_",year,".xlsx")) %>%
  rename(ontime_Count='On-Time Grads',
         Total_Students='Cohort') %>%
...
#import data
dropout_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Dropout_Rates_7th-12th_",year,".xlsx")) %>%
...
```{r}
#import data
assessment_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Assessment_Grade3_",year,".xlsx")) %>%
