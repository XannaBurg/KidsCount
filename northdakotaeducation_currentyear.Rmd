...
```{r}
#import data
specialed_data <- read.csv(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/December1_SpecialEdSnapShots_",year,".csv"))
...
```{r}
#import data
enroll_data <- read.csv(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Enrollment_inclusive_",year,".csv"))
