...
```{r}
#import data
frl_data <- read_excel(path=paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Enrollment_inclusive_",year,".xlsx"),guess_max = 1048576)
...
```{r}
#import data
specialed_data <- read_excel(paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/December1_SpecialEdSnapShots_",year,".xlsx"))
...
```{r}
#import data
enroll_data <- read_excel(path=paste0("/Users/xannaburg/Documents/DO NOT DELETE/ND Education/Enrollment_inclusive_",year,".xlsx"),guess_max = 1048576)
