...
```{r}
#read in the data that was shared by DPHHS
snap <- read_excel(path=paste0("./Input/economics/montana_june_",year,"_tanfsnap.xlsx"),sheet=paste0("SNAP June ",year))
...
```{r}
#read in the data that was shared by DPHHS
tanf <- read_excel(path=paste0("./Input/economics/montana_june_",year,"_tanfsnap.xlsx"),sheet=paste0("TANF June ",year))
