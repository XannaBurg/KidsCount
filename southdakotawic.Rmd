...
```{r}
#import the data
wicdata <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_wic.xlsx"),sheet='State') 

############
#COUNTY DATA
wic_all <- wicdata %>%
  rename(location=`County`,
         data=paste0(year," Average Enrollment")) %>%
...
## STEP 1: IMPORT AND CLEAN THE DATA
```{r}
wicracedata <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_wic.xlsx"),skip=1,
