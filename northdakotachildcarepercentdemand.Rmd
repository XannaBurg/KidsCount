...
upload_sql2 <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM ", database_state," WHERE timeframe='",year,"' AND varname='percentofchildrenages0to13withparentsworkingservedbyececapacity' AND dataformat='Percent';")
