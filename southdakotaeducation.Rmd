...
#requested dataset for enrollment and dropouts
xl_data_enroll <- paste0("./Input/education/southdakota_",year,"_enrollmentdropout.xlsx")
df_enrollment <- read_excel(path=xl_data_enroll, sheet='Drop1920SDPubRate',skip=4)
df_enrollment_nonpublic <- read_excel(path=xl_data_enroll, sheet='Drop1920SDNPRate',skip=4)
