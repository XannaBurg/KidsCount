...
```{r}
#import and clean the data
snapparticipants <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_publicassistance.xlsx"),sheet=paste0("SNAP_By Age Group FY",year_short),skip=1) %>%
...
tanfhouseholds <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_publicassistance.xlsx"),sheet=paste0("TANF_FY",year_short),skip=4) %>%
  ...
  rename(location=paste0("FY",year_short),
         data=Families) %>%
  mutate(location=replace(location,location=='State Totals','South Dakota')) %>%
...
```{r}
#import and clean the data
tanfna <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_publicassistance.xlsx"),sheet=paste0("TANF_Nat Amer FY",year_short),skip=1) %>%
...
```{r}
#import and clean the data
snapna <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_publicassistance.xlsx"),sheet=paste0("SNAP_Nat Amer FY",year_short),skip=1) %>%
...
```{r}
#import and clean the data
medicaidna <- read_excel(path=paste0("./Input/economics/southdakota_",year,"_publicassistance.xlsx"),sheet=paste0("Medicaid_NatAmer FY",year_short),skip=2) %>%
