...
#all years
#upload_data_smokeless<- dbGetQuery(con,paste0("SELECT locationid,location,timeframe,dataformat,data,race FROM montanaWHERE varname = 'yrbs_smokelesstobaccoamonghighschoolstudents';"))
