...
#import the data
childcaredata <- read_excel(path=paste0("./Input/education/southdakota_",year,"_childcaredatabycounty.xlsx"),sheet='Provider Count-with in process') 
...
childcare_county <- childcaredata %>%
  ...
  mutate(category=case_when(
    `Provider Type`=='Day Care Center' ~ 'Licensed child care centers',
    ...
    `Provider Type`=='School Age Care' ~ 'Licensed before and after school programs')) %>%
...
#import the data
childcaredata_slots <- read_excel(path=paste0("./Input/education/southdakota_",year,"_childcaredatabycounty.xlsx"),sheet='AuthSlots-with in process') 
...
#import the data
childcaredata <- read_excel(path=paste0("./Input/education/southdakota_",year,"_childcaredatabycounty.xlsx"),sheet='AuthSlots-with in process') 
