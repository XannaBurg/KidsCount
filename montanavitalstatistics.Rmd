...
montana_5year <- read_excel(path=paste0("./Input/health/montana_",year_minus5,"_",year,"_vitalstatistics_KIDS_COUNT_",year_minus5,"_",year,"v2.xlsx"),sheet='Montana',skip=3) 

counties_5year <- read_excel(path=paste0("./Input/health/montana_",year_minus5,"_",year,"_vitalstatistics_KIDS_COUNT_",year_minus5,"_",year,"v2.xlsx"),sheet='Counties',skip=3) 
