---
title: "Households with no access to a vehicle"
author: "Xanna Burg"
date: "November 2020"
...
for (i in 1:nrow(tribalcodes1)) {
  ...
  acs_tribal[[i]] <- getCensus(name="acs/acs5/profile",
          ...
          vars=c("DP04_0058PE","DP04_0058PM"),
...
acs_tribal3 <- acs_tribal2 %>%
  ...
  select(c(AIANNHNAME,locationtype,DP04_0058PE,DP04_0058PM)) %>%
  ...
  mutate(varname='householdswithnovehicleavailable') %>%
