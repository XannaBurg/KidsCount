...
#edit this to include estimates available prior to current vintage year
pop_sql_prioryears <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM ", database_state," WHERE (vintageyear='2000' OR vintageyear='1990' OR vintageyear='2020') AND varname='totalpopulation';")
