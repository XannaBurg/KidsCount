...
datacenter_sql <- paste0("SELECT locationid, location, timeframe, dataformat, data FROM ", database_state," WHERE timeframe='",acsyear,"' AND varname='employedyouthbyage' AND age_group='16 to 24' AND locationtype <> 'Tribal Area';")
