...
```{r}
#Montana
#fulldata <- read.csv(paste0("../Input/demographics/DATADELIVERY_ Vintage 2022 Population Estimates20230630085928/v2022_co_res_char11_mt.csv"))

#North Dakota
#fulldata <- read.csv(paste0("../Input/demographics/DATADELIVERY_ Vintage 2022 Population Estimates20230630085928/v2022_co_res_char11_nd.csv"))

#South Dakota
#fulldata <- read.csv(paste0("../Input/demographics/DATADELIVERY_ Vintage 2022 Population Estimates20230630085928/v2022_co_res_char11_sd.csv"))
