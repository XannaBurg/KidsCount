...
```{r}
#read in the data
dropout <- read_excel(path=paste0("./Input/education/montana_",year,"_educationdata3b.xlsx"),sheet='County') 
...
```{r}
#read in the data
dropout_race <- read_excel(path=paste0("./Input/education/montana_",year,"_educationdata3b.xlsx"),sheet='Statewide Race-Ethnicity') 
...
##Need to input state estimate in code##
```{r}
grad <- read_excel(path=paste0("./Input/education/montana_",year,"_educationdata3.xlsx"),sheet='County Grad All') 
...
```{r}
#read in the data
testing1 <- read_excel(path=paste0("./Input/education/montana_",year,"_educationdata2.xlsx"),sheet='County') 

###################
#CREATE COUNTY DATA
county_testing1 <- testing1 %>%
  rename(data='PercentProficientELA',
         location=countyname) %>% 
