...
#create one dataset that is for age 0-5 matching the reported year
#create a second dataset that is for age 0-5, but will be used for calculating child care estimates for the year +1 of the reported year
#create a third dataset that is for age 0-4 for WIC and will be used for calculating WIC estimates for the year +1 of the reported year

#2023 estimates
pop_2023_sql <- paste0("SELECT location, timeframe, age_group, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='childpopulationbysingleyearofage' AND dataformat='Number' AND vintageyear='2023' AND timeframe='2023';")

pop23 <- dbGetQuery(con,pop_2023_sql) %>%
...
pop23v3 <- dbGetQuery(con,pop_2023_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=4) %>%
  group_by(location,timeframe) %>%
...
#2022 estimates
pop_2022_sql <- paste0("SELECT location, timeframe, age_group, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='childpopulationbysingleyearofage' AND dataformat='Number' AND vintageyear='2022' AND timeframe='2022';")

pop22 <- dbGetQuery(con,pop_2022_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=5) %>%
  group_by(location,timeframe) %>%
...
pop22v3 <- dbGetQuery(con,pop_2022_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=4) %>%
  group_by(location,timeframe) %>%
...
pop21v3 <- dbGetQuery(con,pop_2021_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=4) %>%
  group_by(location,timeframe) %>%
...
pop24_combined <- pop23v2 %>%
  left_join(pop23v3,by=c('location'='location','timeframe'='timeframe'))
pop23_combined <- pop23 %>%
  left_join(pop22v2,by=c('location'='location','timeframe'='timeframe')) %>%
  left_join(pop22v3,by=c('location'='location','timeframe'='timeframe'))
pop22_combined <- pop22 %>%
  left_join(pop21v2,by=c('location'='location','timeframe'='timeframe')) %>%
  left_join(pop21v3,by=c('location'='location','timeframe'='timeframe'))
pop21_combined <- pop21 %>%
  left_join(pop20v2,by=c('location'='location','timeframe'='timeframe')) %>%
  left_join(pop20v3,by=c('location'='location','timeframe'='timeframe'))
...
pop <- pop17_combined %>%
  ...
  bind_rows(pop22_combined) %>%
  bind_rows(pop23_combined) %>%
  bind_rows(pop24_combined)
...
pop23_children <- dbGetQuery(con,pop_2023_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=17) %>%
  group_by(location,timeframe) %>%
...
pop22_children <- dbGetQuery(con,pop_2022_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=17) %>%
  group_by(location,timeframe) %>%
...
pop21_children <- dbGetQuery(con,pop_2021_sql) %>%
  mutate(age_group=as.numeric(paste(age_group))) %>%
  mutate(data=as.numeric(paste(data))) %>%
  subset(age_group<=17) %>%
  group_by(location,timeframe) %>%
...
pop_children <- pop17_children %>%
  ...
  bind_rows(pop21_children) %>%
  bind_rows(pop22_children) %>%
  bind_rows(pop23_children)
...
#COUNTY DATA
acs_county_23 <- getCensus(name="acs/acs5",
          vintage=2023,
...
#STATE DATA
acs_state_23 <- getCensus(name="acs/acs5",
          vintage=2023,
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B23008_002E","B23008_002M","B23008_004E","B23008_004M",
                 "B23008_010E","B23008_010M","B23008_013E","B23008_013M",
...
acs_23 <- acs_county_23 %>%
  bind_rows(acs_state_23) %>%
...
#COUNTY DATA
acs_county_22 <- getCensus(name="acs/acs5",
          vintage=2022,
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B23008_002E","B23008_002M","B23008_004E","B23008_004M",
                 "B23008_010E","B23008_010M","B23008_013E","B23008_013M",
...
#STATE DATA
acs_state_22 <- getCensus(name="acs/acs5",
          vintage=2022,
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B23008_002E","B23008_002M","B23008_004E","B23008_004M",
                 "B23008_010E","B23008_010M","B23008_013E","B23008_013M",
...
acs_22 <- acs_county_22 %>%
  bind_rows(acs_state_22) %>%
...
#2021
totalpopulation_21_sql <- paste0("SELECT location, timeframe, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='totalpopulation' AND (vintageyear='2021' AND timeframe='2021');")

totalpopulation_21 <- dbGetQuery(con,totalpopulation_21_sql) %>%
  rename(totalpopulation=data)

#2022
totalpopulation_22_sql <- paste0("SELECT location, timeframe, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='totalpopulation' AND (vintageyear='2022' AND timeframe='2022');")

totalpopulation_22 <- dbGetQuery(con,totalpopulation_22_sql) %>%
  rename(totalpopulation=data)

#2023
totalpopulation_23_sql <- paste0("SELECT location, timeframe, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='totalpopulation' AND (vintageyear='2023' AND timeframe='2023');")

totalpopulation_23 <- dbGetQuery(con,totalpopulation_23_sql) %>%
  rename(totalpopulation=data)
...
totalpopulation <- totalpopulation_17 %>%
  ...
  bind_rows(totalpopulation_21) %>%
  bind_rows(totalpopulation_22) %>%
  bind_rows(totalpopulation_23) 
...
pnc_3year <- dbGetQuery(con,prenatalcare3_sql) %>%
  subset(timeframe=='2015-2017' | timeframe=='2016-2018' | timeframe=='2017-2019' | timeframe=='2018-2020' | timeframe=='2019-2021' | timeframe=='2020-2022' | timeframe=='2021-2023') %>%
...
pnc_5year <- dbGetQuery(con,prenatalcare5_sql) %>%
  subset(timeframe=='2013-2017' | timeframe=='2014-2018' | timeframe=='2015-2019' | timeframe=='2016-2020' | timeframe=='2017-2021' | timeframe=='2018-2022' | timeframe=='2019-2023') %>%
...
###########################
#WIC
wic_sql <- paste0("SELECT location, timeframe,data,varname FROM montana WHERE (locationtype='County' OR locationtype='State') AND (varname='wicparticipants' OR varname='wicparticipants_infantsandchildren') AND (timeframe='2017' OR timeframe='2018' OR timeframe='2019' OR timeframe='2020' OR timeframe='2021' OR timeframe='2022' OR timeframe='2023' OR timeframe='2024');")
...
#THIRD GRADE READING
#1 year
reading1_sql <- paste0("SELECT location, timeframe, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='thirdgradestateelaproficiency1year' AND dataformat='Percent' AND (timeframe='2017/18' OR timeframe='2018/19' OR timeframe='2019/20' OR timeframe='2020/21' OR timeframe='2021/22' OR timeframe='2022/23' OR timeframe='2023/24');")
...
#3 year
reading3_sql <- paste0("SELECT location, timeframe, data FROM montana WHERE (locationtype='County' OR locationtype='State') AND varname='thirdgradestateelaproficiency3year' AND dataformat='Percent' AND (timeframe='2016-2018' OR timeframe='2017-2019' OR timeframe='2022-2024');")
...
#2019-2023
poverty_2023_county <- getCensus(name="acs/acs5",
          vintage='2023',
          key=Sys.getenv("CENSUS_API_KEY"),
...
poverty_2023_state <- getCensus(name="acs/acs5",
          vintage='2023',
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B17024_002E","B17024_003E","B17024_004E","B17024_005E","B17024_006E","B17024_007E","B17024_008E","B17024_009E","B17024_002M","B17024_003M","B17024_004M","B17024_005M","B17024_006M","B17024_007M","B17024_008M","B17024_009M"),
          region="state:30") %>%
...
poverty_2023 <- poverty_2023_county %>% bind_rows(poverty_2023_state) %>%
...
#2018-2022
poverty_2022_county <- getCensus(name="acs/acs5",
          vintage='2022',
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B17024_002E","B17024_003E","B17024_004E","B17024_005E","B17024_006E","B17024_007E","B17024_008E","B17024_009E","B17024_002M","B17024_003M","B17024_004M","B17024_005M","B17024_006M","B17024_007M","B17024_008M","B17024_009M"),
          region="county:*",
...
poverty_2022_state <- getCensus(name="acs/acs5",
          vintage='2022',
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B17024_002E","B17024_003E","B17024_004E","B17024_005E","B17024_006E","B17024_007E","B17024_008E","B17024_009E","B17024_002M","B17024_003M","B17024_004M","B17024_005M","B17024_006M","B17024_007M","B17024_008M","B17024_009M"),
          region="state:30") %>%
...
poverty_2022 <- poverty_2022_county %>% bind_rows(poverty_2022_state) %>%
...
#2017-2021
poverty_2021_county <- getCensus(name="acs/acs5",
          vintage='2021',
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B17024_002E","B17024_003E","B17024_004E","B17024_005E","B17024_006E","B17024_007E","B17024_008E","B17024_009E","B17024_002M","B17024_003M","B17024_004M","B17024_005M","B17024_006M","B17024_007M","B17024_008M","B17024_009M"),
          region="county:*",
...
poverty_2021_state <- getCensus(name="acs/acs5",
          vintage='2021',
          key=Sys.getenv("CENSUS_API_KEY"),
          vars=c("B17024_002E","B17024_003E","B17024_004E","B17024_005E","B17024_006E","B17024_007E","B17024_008E","B17024_009E","B17024_002M","B17024_003M","B17024_004M","B17024_005M","B17024_006M","B17024_007M","B17024_008M","B17024_009M"),
          region="state:30") %>%
...
poverty_2021 <- poverty_2021_county %>% bind_rows(poverty_2021_state) %>%
...
poverty <- poverty_2016 %>%
  ...
  bind_rows(poverty_2021) %>%
  bind_rows(poverty_2022) %>%
  bind_rows(poverty_2023
            ) %>%
...
#write.csv(montana_data,"../Output/datarequests/montana_mchdata_4.24.25.csv",row.names=FALSE)
...
montana_data_urbanrural <- montana_data %>%
  ...
  mutate(countytype=case_when((location=="Cascade" | location=="Flathead" | location=="Gallatin" | 
         ...
         TRUE ~ "Rural")) %>%
  subset(timeframe=='2024' & category=='Total') %>%
...
#write.csv(montana_data_urbanrural,"../Output/datarequests/montana_mchdata_childcare_urbanruralcalculations.csv",row.names=FALSE)
...
#write.csv(montana_data_state,"../Output/datarequests/montana_mchdata_childcare_statecalculations.csv",row.names=FALSE)
...
montana_county_factcheck <- montana_data %>%
  ...
  mutate(childcaredemand=pop_0to5_childcare*percent_workingparents_under6) %>%
  mutate(averagepercentneed=childcarecapacity/childcaredemand) %>%
  select(c(location,childcarecapacity,averagepercentneed,pop_0to5_childcare,percent_workingparents_under6,childcaredemand))
...
montana_data_urbanrural2 <- montana_data %>%
  ...
  mutate(countytype=case_when((location=="Cascade" | location=="Flathead" | location=="Gallatin" | 
                              ...
                              location=="Silver Bow" | location=="Yellowstone") ~ "Urban",
         TRUE ~ "Rural")) %>%
  subset(timeframe=='2023' & category=='Total') %>%
  group_by(countytype) %>%
  summarise(totaldenominator_0to5=sum(pop_0to5),
            totaldenominator_0to17=sum(pop_0to17))

#write.csv(montana_data_urbanrural2,"../Output/datarequests/montana_mchdata_fostercare_urbanruralcalculations.csv",row.names=FALSE)
...
montana_wic_urbanrural <- montana_data %>%
  ...
  mutate(wic_infantschildren=replace(wic_infantschildren,location=='Petroleum',0)) %>%
  group_by(countytype) %>%
  summarise(averagepercentwic=sum(wic_infantschildren)/(sum(wic_eligible)))

#write.csv(montana_wic_urbanrural,"../Output/datarequests/montana_mchdata_wic_urbanruralcalculations.csv",row.names=FALSE)
...
#write.csv(montana_wic_state,"../Output/datarequests/montana_mchdata_wic_statecalculations.csv",row.names=FALSE)
