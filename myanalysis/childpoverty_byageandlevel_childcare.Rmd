...
parentsworking_sql <- paste0("SELECT location, age_group, data FROM southdakota WHERE timeframe='2017-2021' AND (varname='childrenwithparentsinlaborforce') AND dataformat='Percent' AND (locationtype='County' OR locationtype='State');")
